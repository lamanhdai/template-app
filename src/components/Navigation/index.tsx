  ...
  return (
    ...
    <StyledHeader className="header">
      <div className="container-xl">
        <div className="row">
          <div className="header__brand col col-md-2">
            <StyledLogo to={'/'} title="Indigo" className="logo">Indigo</StyledLogo>
          </div>
          <div className="header__mobile-menu d-md-none">
            <a href="#" className="toggle-nav"></a>
          </div>
          <div className="col-xl-6">
            <nav className="main-nav">
              <ul className="main-nav__list">
                <StyledNavItem><StyledNavLinkItem to="shop.html">New collection</StyledNavLinkItem></StyledNavItem>
                <StyledNavItem><StyledNavLinkItem to="shop.html">Catalog</StyledNavLinkItem></StyledNavItem>
                <StyledNavItem><StyledNavLinkItem to="shop.html">Promotion</StyledNavLinkItem></StyledNavItem>
                <StyledNavItem><StyledNavLinkItem to="shop.html">Gift card</StyledNavLinkItem></StyledNavItem>
              </ul>
            </nav>
          </div>

          <div className="d-flex justify-center col-xl-4">
            <ul className="header-controls">
              <li className="header-search">
                <StyledButtonHeader href="#" className="reveal-search button-search" size="15">
                   Search
                </StyledButtonHeader>
              ...
              <li className="header-cart">
                <StyledButtonHeader href="cart.html" title="view cart" className="button-product" size="15">
              ...
              <li className="header-actions">
                <StyledButtonHeader href="#" title="Log out" className="button-logout" size="15"><span className="fa fa-lock"></span> Log out</StyledButtonHeader>
              </li>
            </ul>
          </div>
        </div>
