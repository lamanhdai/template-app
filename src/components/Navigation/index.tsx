      ...
      <div className="max-w-screen-xl flex flex-wrap items-center mx-auto ">
        ...
        <div className="flex md:order-2 ml-auto">
          ...
          <div className="hidden md:flex">
            <StyledButtonSearch size={15}>SEARCH</StyledButtonSearch>
            <StyledButtonLogout size={15}>LOG OUT</StyledButtonLogout>
          </div>
          <Button data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false" onClick={() => setMenuOpened(!menuOpened)}>
            <span className="sr-only">Open menu</span>
            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
          </Button>
        </div>
        <div className={`items-center justify-between md:flex md:order-1 w-full md:w-auto ${!menuOpened&&'hidden'}`} id="navbar-search">
          ...
          <StyledMainNav className="flex flex-col mt-4 md:flex-row md:mt-0">
            <StyledNavItem>
